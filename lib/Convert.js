 ...
 * @returns {Array}
 */
var toSelectData = function toSelectData(list, valueKey, labelKey) {
 ...
 */
var findItem = function findItem(list, value) {
...
var findItems = function findItems(list, value) {
    var key = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'id';
 ...
 * @returns {*}
 */
var toIdentity = function toIdentity(identityNumber) {
    var info = {
 ...
 * @returns {Number}
 */
var toRate = function toRate(value) {
...
var toYuan = function toYuan(value) {
    var exchange = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
    var fractionSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;

    var k = value / exchange;
